package com.mwsp.countrycase.helpers
...
class CountriesAdapter(private val countriesList: List<MyCountry>) : RecyclerView.Adapter<CountriesAdapter.ViewHolder>() {
        ...
        class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            val tvDeaths = itemView.findViewById<TextView>(R.id.tvDeaths)
            val tvPopulation = itemView.findViewById<TextView>(R.id.tvPopulation)
            ...
            fun bind(country: MyCountry) {
                ...
                tvCases.text = name
                val death = "Deaths : ${country.deaths.toString()}"
                tvDeaths.text = death
                val popul = "Population :${country.population.toString()}"
                tvPopulation.text = popul
